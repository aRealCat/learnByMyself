...
function StorePlugin (hotInstance) {
...
StorePlugin.prototype = Object.create(Handsontable.plugins.BasePlugin.prototype, {
  constructor: {
    writable: true,
    configurable: true,
    value: StorePlugin
 ...
 */
StorePlugin.prototype.isEnabled = function () {
  // return !!this.hot.getSettings().externalPluginSkeleton
  if (typeof this.hot.getSettings().externalPluginSkeleton === 'undefined') {
    return true
  }
  return !!this.hot.getSettings().externalPluginSkeleton
}
 ...
 */
StorePlugin.prototype.enablePlugin = function () {
 ...
 */
StorePlugin.prototype.disablePlugin = function () {
  // this.yourProperty = ''
  // this.anotherProperty = []
 ...
 */
StorePlugin.prototype.updatePlugin = function () {
 ...
 */
StorePlugin.prototype.onAfterChange = function (changes, source) {
 ...
 */
StorePlugin.prototype.destroy = function () {
